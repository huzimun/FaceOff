...
export adversarial_folder_name="ipadapter,ipadapter-plus,photomaker_VGGFace2_hflip0_kernel7_gau1_cosine_w0.5_num100_alpha0.005_eps16_input512_yingbu_grdipure"
export save_config_dir="./outputs/config_scripts_logs/${adversarial_folder_name}"
mkdir $save_config_dir
cp "./scripts/gen/gen_ipadapter_ipadapter-plus_photomaker3.sh" $save_config_dir
