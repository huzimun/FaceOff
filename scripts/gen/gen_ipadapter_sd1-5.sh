...
# export experiment_name="ipadapter_VGGFace2_cosine_w0.5_num100_alpha6_eps16_input512_224_yingbu_refiner1_edge200-100_filter3_min-eps8_interval10"
# export device="cuda:0"
# export save_config_dir="./outputs/config_scripts_logs/${experiment_name}"
# mkdir $save_config_dir
# cp "./scripts/gen/gen_ipadapter_sd1-5.sh" $save_config_dir
...
# export adversarial_folder_name="ipadapter_VGGFace2_cosine_w0.5_num100_alpha6_eps16_input512_224_yingbu_refiner1_edge200-100_filter3_min-eps8_interval10_jpeg75"
# export experiment_name="ipadapter_VGGFace2_cosine_w0.5_num100_alpha6_eps16_input512_224_yingbu_refiner1_edge200-100_filter3_min-eps8_interval10_jpeg75"
# export device="cuda:0"
# export save_config_dir="./outputs/config_scripts_logs/${experiment_name}"
# mkdir $save_config_dir
# cp "./scripts/gen/gen_ipadapter_sd1-5.sh" $save_config_dir
...
export adversarial_folder_name="ipadapter_VGGFace2_cosine_w0.5_num100_alpha6_eps16_input512_224_yingbu_refiner1_edge200-100_filter3_min-eps8_interval10_sr"
export experiment_name="ipadapter_VGGFace2_cosine_w0.5_num100_alpha6_eps16_input512_224_yingbu_refiner1_edge200-100_filter3_min-eps8_interval10_sr"
export device="cuda:0"
export save_config_dir="./outputs/config_scripts_logs/${experiment_name}"
mkdir $save_config_dir
cp "./scripts/gen/gen_ipadapter_sd1-5.sh" $save_config_dir
...
export adversarial_folder_name="ipadapter_VGGFace2_cosine_w0.5_num100_alpha6_eps16_input512_224_yingbu_refiner1_edge200-100_filter3_min-eps8_interval10_tvm"
export experiment_name="ipadapter_VGGFace2_cosine_w0.5_num100_alpha6_eps16_input512_224_yingbu_refiner1_edge200-100_filter3_min-eps8_interval10_tvm"
export device="cuda:0"
export save_config_dir="./outputs/config_scripts_logs/${experiment_name}"
mkdir $save_config_dir
cp "./scripts/gen/gen_ipadapter_sd1-5.sh" $save_config_dir
