export adversarial_folder_name="ipadapter,ipadapter-plus,photomaker_VGGFace2_gau,none_kernel7_cosine_w0.5_num100_alpha0.005_eps16_input224_yingbu-gaussian-noise0.1_sr"
export save_config_dir="./outputs/config_scripts_logs/${adversarial_folder_name}"
mkdir $save_config_dir
cp "./scripts/gen/gen_ipadapter_ipadapter-plus_photomaker8.sh" $save_config_dir
...
export adversarial_folder_name="ipadapter,ipadapter-plus,photomaker_VGGFace2_cosine_w0.5_num100_alpha0.005_eps16_input224_yingbu-gaussian-noise0.1_sr"
export save_config_dir="./outputs/config_scripts_logs/${adversarial_folder_name}"
mkdir $save_config_dir
cp "./scripts/gen/gen_ipadapter_ipadapter-plus_photomaker8.sh" $save_config_dir
export device="cuda:5"
