export model_type='vae' # 攻击的模型，photomaker_clip，vae，clip，ipadapter
export pretrained_model_name_or_path='/data1/humw/Pretrains/stable-diffusion-2-1-base'  # "/data1/humw/Pretrains/photomaker-v1.bin"，'/data1/humw/Pretrains/IP-Adapter/models/image_encoder'，'/data1/humw/Pretrains/stable-diffusion-2-1-base'
...
export model_input_size=512 # 模型输入图片尺寸
export target_type="mist" # target图片的类型，max代表最大clip特征mse距离, yingbu代表target image为yingbu
...
cp "./scripts/attack/faceoff_dreambooth1.sh" $save_config_dir
