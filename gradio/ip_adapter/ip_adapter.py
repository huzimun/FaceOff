...
class IPAdapter:
    ...
    def generate(
        ...
        **kwargs,
        ...
        image_prompt_embeds = image_prompt_embeds.repeat(1, num_samples, 1) # 如果传入4张图像，torch.Size([4, 64, 768])
        image_prompt_embeds = image_prompt_embeds.view(bs_embed * num_samples, seq_len, -1) # torch.Size([4, 16, 768])，如果传入4张图像，torch.Size([16, 16, 768])
