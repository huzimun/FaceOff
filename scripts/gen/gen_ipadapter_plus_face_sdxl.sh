...
# export experiment_name="ip_adapter_sdxl_plus-face_${adversarial_folder_name}"
# export device="cuda:0"

# export save_config_dir="./outputs/config_scripts_logs/${experiment_name}"
# mkdir $save_config_dir
# cp "./scripts/gen/gen_ipadapter_plus_face_sdxl.sh" $save_config_dir
...
export adversarial_folder_name="Encoder_attack_conda-photomaker_VGGFace2_vae15-ipadapter-photomaker_mix_eot-0_yingbu_agm-111_norm-0"
export experiment_name="ip_adapter_sdxl_plus-face_${adversarial_folder_name}"
export device="cuda:0"
