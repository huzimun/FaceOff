export adversarial_folder_name="face_diffuser_VGGFace2_w0.0_num50_alpha6_eps16_input512_224_max_refiner0"
...
export adversarial_folder_name="face_diffuser_VGGFace2_w0.0_num200_alpha6_eps16_input512_224_max_refiner0"
echo $adversarial_folder_name
export device="cuda:0"
export adversarial_input_dir="./outputs/adversarial_images/${adversarial_folder_name}"
export customization_output_dir="./outputs/customization_outputs/${adversarial_folder_name}"
...
export adversarial_folder_name="fastcomposer_VGGFace2_w0.0_num50_alpha6_eps16_input512_224_max_refiner0"
echo $adversarial_folder_name
export device="cuda:0"
export adversarial_input_dir="./outputs/adversarial_images/${adversarial_folder_name}"
export customization_output_dir="./outputs/customization_outputs/${adversarial_folder_name}"
...
export adversarial_folder_name="fastcomposer_VGGFace2_w0.0_num200_alpha6_eps16_input512_224_max_refiner0"
echo $adversarial_folder_name
export device="cuda:0"
export adversarial_input_dir="./outputs/adversarial_images/${adversarial_folder_name}"
export customization_output_dir="./outputs/customization_outputs/${adversarial_folder_name}"
