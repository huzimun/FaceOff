export adversarial_folder_name="ipadapter,ipadapter-plus,photomaker_VGGFace2_gau,none_kernel7_cosine_w0.5_num100_alpha0.005_eps16_input224_yingbu"
export customization_folder_name="ipadapter_sd1-5_${adversarial_folder_name}"
...
cp "./scripts/eval/eval_ipadapter_ipadapter-plus_sd15.sh" $save_config_dir
...
export customization_folder_name="ipadapter-plus_sd1-5_${adversarial_folder_name}"
export customization_output_dir="./outputs/customization_outputs/${customization_folder_name}"
export evaluation_output_dir="./outputs/evaluation_outputs/${customization_folder_name}"
export prompts="a_photo_of_person;a_dslr_portrait_of_person"
echo $prompts
