...
export adversarial_folder_name="unet_sds_ipadapter_${data_dir_name}_${loss_choice}_w${w}_num${attack_num}_alpha${alpha}_eps${eps}_input${input_size}_${target_type}";
...
cp "./scripts/attack/ensemble_faceoff_unet_sds.sh" $save_config_dir

python ./attack/ensemble_faceoff_unet_sds.py \
    --unet_path $unet_path \
