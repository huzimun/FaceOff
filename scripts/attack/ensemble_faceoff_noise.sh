...
export eot_trans_types="noise,none" # none, hflip, gau, gau-hflip
...
cp "./scripts/attack/ensemble_faceoff_noise.sh" $save_config_dir

python ./attack/ensemble_faceoff_jpeg_noise.py \
    --mode "idprotector" \
