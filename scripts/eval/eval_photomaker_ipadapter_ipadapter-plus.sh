export CelebA-HQ_adversarial_folder_name="idprotector_new-CelebA-HQ"
export VGGFace2_adversarial_folder_name="ipadapter,ipadapter-plus,photomaker_VGGFace2_cosine_w1_num100_alpha0.005_eps16_input224_mist_jpeg75"

export adversarial_folder_name=${CelebA-HQ_adversarial_folder_name}
...
cp "./scripts/eval_photomaker.sh" $save_config_dir
