...
export adversarial_folder_name="vae_ipadapter_face_diffuser_${data_dir_name}_mse_cosine_w${w}_num${attack_num}_alpha${alpha}_eps${eps}_input${input_size}_${target_type}";
...
cp "./scripts/attack/ensemble_faceoff_mse_cos.sh" $save_config_dir

python ./attack/ensemble_faceoff_mse_cos.py \
