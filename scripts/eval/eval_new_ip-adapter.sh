export adversarial_folder_name="sd2-1-ipadapter_VGGFace2_cosine_w0.5_num100_alpha6_eps16_input512_224_yingbu_refiner0"
...
export adversarial_folder_name="sdxl-ipadapter_VGGFace2_cosine_w0.5_num100_alpha6_eps16_input512_224_yingbu_refiner0"
echo $adversarial_folder_name
export device="cuda:0"
export adversarial_input_dir="./outputs/adversarial_images/${adversarial_folder_name}"
export customization_output_dir="./outputs/customization_outputs/${adversarial_folder_name}"
