...
export pretrained_model_name_or_path="/home/humw/Pretrains/h94/IP-Adapter/models/image_encoder"  # "/data1/humw/Pretrains/photomaker-v1.bin"，"/data1/humw/Pretrains/IP-Adapter/models/image_encoder"，"/data1/humw/Pretrains/stable-diffusion-2-1-base"
...
export target_type="yingbu" # type of target image: max is max clip embedding mse distance, yingbu is beijing opera mask, mist is mist image, gray is gray image
...
cp "./scripts/attack/faceoff_ip-adapter.sh" $save_config_dir
