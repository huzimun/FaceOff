...
export experiment_name="photomaker_RealVisXL_V3.0_"$adversarial_folder_name
python ./customization/target_model/PhotoMaker/inference.py \
  ...
  --base_model_path "/home/humw/Pretrains/RealVisXL_V3.0" \
  --device $device \
  --seed 42 \
  --num_steps 50 \
...
export experiment_name="ipadapter_RealVisXL_V3.0_"$adversarial_folder_name
python ./customization/target_model/IP-Adapter/a_ip_adapter_sdxl_demo.py \
    --model_type "sdxl" \
    --base_model_path "/home/humw/Pretrains/RealVisXL_V3.0" \
...
export experiment_name="ipadapter-plus_RealVisXL_V3.0_"$adversarial_folder_name
python ./customization/target_model/IP-Adapter/a_ip_adapter_sdxl_plus-face_demo.py \
    --model_type "sdxl" \
    --base_model_path "/home/humw/Pretrains/RealVisXL_V3.0" \
    --image_encoder_path "/home/humw/Pretrains/h94/IP-Adapter/models/image_encoder" \
