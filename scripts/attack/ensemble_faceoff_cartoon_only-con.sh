...
export target_type="cartoon" # target图片的类型，max代表最大clip特征mse距离, yingbu代表target image为yingbu, mist代表mist图像
export device="cuda:7"
export loss_choice="cosine" # mse or cosine
export eot_trans_types="none" # none, hflip, gau, gau-hflip
...
cp "./scripts/attack/ensemble_faceoff_cartoon_only-con.sh" $save_config_dir
